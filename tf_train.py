...
if testing:
	...
	figure_path = "figures/"
	model_path = "retrained_capstone/"
	metrics_file = "official_metrics.csv"
...
valid_combinations = []
trained_combinations = [(1, 0.5), (1, 1), (1, 3), (1,5)]
...
# loop through all alpha_d and 
for alpha_d, alpha_g in valid_combinations:
	...
	final_y = generateReturns(final_generator, gaussian_noise, postprocessed=True)
